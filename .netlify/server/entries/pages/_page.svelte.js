...
import { c as constants } from "../../chunks/functions.js";
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return ` <div class="bg-cover bg-center" style="background-image: url('/bg-fundo-mar.jpeg');"><header><nav class="flex sm:flex-col xl:flex-row items-center justify-around py-2"><div class="sm:mb-2 md:mb-0" data-svelte-h="svelte-rnr6nv"><a href="/" class="flex items-center sm:gap-4 md:gap-8"><img src="/logo-removebg.png" alt="subimersa logo" class="sm:w-20 md:w-28 xl:w-36"> <p class="text-3xl font-semibold hidden lg:block"><span class="font-bold">Subimersa</span> | Curso de Pesca Submarina</p> <div class="flex flex-col items-center sm:block lg:hidden"><p class="text-3xl font-bold">Subimersa</p> <p class="text-xl font-semibold">Curso de Pesca Submarina</p></div></a></div> <div class="flex gap-8 sm:mb-1 md:mb-0"><a href="/sobre" class="text-lg font-semibold" title="${"Sobre " + escape(constants.name_long, true)}" data-svelte-h="svelte-1982rs9">Sobre</a> <a href="/cursos" class="text-lg font-semibold" title="Nossos Cursos" data-svelte-h="svelte-1qldtvb">Cursos</a> <button class="text-lg font-semibold" title="Contato via WhatsApp" data-svelte-h="svelte-1g29qft">Contato</button> <a${add_attribute("href", constants.online_store, 0)} target="_blank" class="text-lg font-semibold" title="Conheça nossos Produtos" data-svelte-h="svelte-1mwspms">Loja Virtual</a></div></nav></header> <section class="sm:pt-10 md:pt-0"><div class="grid max-w-screen-xl sm:px-4 sm:py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12"><div class="place-self-center sm:text-center lg:text-left lg:col-span-7 lg:pl-4 pt-0 lg:-mt-20"><h1 class="max-w-2xl mb-8 sm:!text-3xl lg:!text-4xl xl:!text-5xl" data-svelte-h="svelte-1bvee2v">Curso de Pesca Subaquática em Apneia</h1> <p class="max-w-2xl font-semibold text-gray-700 sm:mb-6 lg:mb-10 sm:!text-xl md:!text-3xl" data-svelte-h="svelte-6f36k0">Descubra a emoção da pesca mais radical e sustentável conectando-se com a natureza
					subaquática de uma forma única</p>  <div class="flex sm:justify-center lg:justify-start sm:gap-8 lg:gap-4"><a href="/cursos" title="Cursos" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border border-gray-300 rounded-lg hover:bg-blue-1 focus:ring-4 focus:ring-gray-100 bg-blue-3" data-svelte-h="svelte-o3x1py">Cursos</a> <button title="Contato" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border border-gray-300 rounded-lg hover:bg-blue-1 focus:ring-4 focus:ring-gray-100 bg-blue-3" data-svelte-h="svelte-hcbmxe">Contato</button></div>  <div class="flex sm:justify-center items-center lg:justify-start gap-8 pt-8" data-svelte-h="svelte-1rc9uu2"><div class="sm:max-w-20 lg:max-w-28 xl:max-w-32"><img src="/CBPDS.gif" alt="Confederação Brasileira de Pesca e Desportos Subaquáticos"></div> <div class="sm:max-w-32 lg:max-w-48 xl:max-w-56"><img src="/CMAS.png" alt="Confederacao Mundial de Atividades Subaquáticas"></div></div></div> <div class="place-self-center sm:max-w-sm lg:max-w-md 2xl:max-w-2xl sm:my-10 lg:mt-0 lg:col-span-5" data-svelte-h="svelte-1ybno9r"><img src="subimersa_20.jpeg" alt="pescador e sua garoupa" class="rounded-3xl lg:rounded-full"></div></div></section></div>`;
});
...
const Faq = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<div class="bg-gray-50">${validate_component(Accordion, "Accordion").$$render(
    $$result,
    {
      class: "max-w-2xl lg:max-w-3xl mx-auto my-16 py-16"
    },
    {},
    {
      default: () => {
        return `<h2 class="text-center mb-4" data-svelte-h="svelte-93appb">Perguntas Frequentes</h2> ${validate_component(AccordionItem, "AccordionItem").$$render($$result, {}, {}, {
          ...
          default: () => {
            return `<div class="py-5 border-gray-200" data-svelte-h="svelte-gn0fm"><p class="mb-2 text-gray-500 !text-xl">A pesca subaquática é uma atividade esportiva que combina a prática de mergulho livre (em
					apneia) com a pesca esportiva mais seletiva e sustentável do planeta.</p> <p class="mb-2 text-gray-500">É uma experiência única que permite explorar o mundo subaquático e ter contato direto com
					a natureza, e animais incríveis que lá vivem.</p> <p class="mb-2 text-gray-500">Oferece desafios físicos e mentais, além de proporcionar momentos de grande satisfação e
					emoção.</p></div>`;
          }
          ...
          default: () => {
            return `<div class="py-5 border-gray-200" data-svelte-h="svelte-zx3u1j"><p class="mb-2 text-gray-500">Benefícios físicos: Melhora da resistência física, força muscular, coordenação motora,
					...
					natureza.</p> <p class="text-gray-500">Coleta do Próprio Alimento: além de ser uma incrível e prazerosa forma de pescar seu
					próprio peixe de maneira respeitosa e sustentável, proporcionando momentos especiais para
					você e sua família.</p></div>`;
          }
        })} ${validate_component(AccordionItem, "AccordionItem").$$render($$result, { class: "mt-2" }, {}, {
          header: () => {
            return `<span slot="header" class="text-2xl" data-svelte-h="svelte-jjd0bv">Como posso me inscrever no curso de pesca subaquática?</span>`;
          },
          default: () => {
            return `<div class="py-5 border-gray-200"><p class="mb-2 text-gray-500">Entre em contato conosco através do nosso <button class="text-lg font-bold" title="Contato via WhatsApp" data-svelte-h="svelte-1b3ahna">WhatsApp clicando aqui</button></p></div>`;
          }
        })}`;
      }
    }
...
const Testimonials = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  const videos = [
    {
      author: "Hudson",
      video: "/testimonials/testimonial_1.mp4"
    },
    {
      author: "Cristian",
      video: "/testimonials/testimonial_2.mp4"
    },
    {
      author: "Lucas",
      video: "/testimonials/testimonial_3.mp4"
    },
    {
      author: "Pedro Paulo",
      video: "/testimonials/testimonial_4.mp4"
    },
    {
      author: "Mauricio",
      video: "/testimonials/testimonial_5.mp4"
    }
  ];
  return `<section><div class="gap-16 items-center sm:py-8 sm:px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6"><div data-svelte-h="svelte-b3wvfj"><h2 class="mb-4">Veja o que nossos alunos falam sobre nós</h2> <p class="mb-4 font-semibold text-gray-500">Confira os depoimentos dos nossos alunos e veja como o curso transformou suas experiências
				na pesca subaquática. Independentemente do nível, todos encontram no curso o suporte
				necessário para aprimorar suas habilidades e viver essa aventura de forma segura.</p></div> <div class="gap-4 mt-8 carousel flex justify-center"><button class="bg-gray-700 text-white rounded-full sm:h-10 sm:w-10 md:h-8 md:w-8 my-auto text-xl" data-svelte-h="svelte-12fark5">❮</button> <div class="carousel-inner w-7/12 md:w-4/12 xl:w-7/12"><video${add_attribute("src", videos[currentIndex].video, 0)} controls muted autoplay controlslist="nodownload" preload="auto" playsinline class="w-full h-[34rem] object-cover rounded-lg"${add_attribute("this", videoElement, 0)}><track kind="captions"></video> <div class="relative h-16 w-full bottom-28 md:bottom-32 right-0 text-white font-bold bg-black bg-opacity-60 px-4 py-5 rounded-lg">Aluno: ${escape(videos[currentIndex].author)}</div></div> <button class="bg-gray-700 text-white rounded-full h-10 w-10 md:h-8 md:w-8 my-auto text-xl" data-svelte-h="svelte-mxgji6">❯</button></div></div></section>`;
});
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  const meta = {
    metaTitle: "Subimersa | Curso de Pesca Submarina e Apneia",
    metaDescription: "A Subimersa oferece cursos completos de pesca submarina em apneia, ministrados por instrutores certificados. Transforme sua experiência na pesca subaquática com segurança e excelência."
  };
  return `${validate_component(Head, "Head").$$render($$result, { data: meta }, {}, {
    default: () => {
      return `<title>${escape(meta.metaTitle)}</title>`;
    }
  })} ${validate_component(Hero, "Hero").$$render($$result, {}, {}, {})} ${validate_component(Services, "Services").$$render($$result, {}, {}, {})} ${validate_component(About, "About").$$render($$result, {}, {}, {})} ${validate_component(Cta, "Cta").$$render($$result, {}, {}, {})} ${validate_component(Why, "Why").$$render($$result, {}, {}, {})} ${validate_component(Faq, "Faq").$$render($$result, {}, {}, {})} ${validate_component(Cta, "Cta").$$render($$result, {}, {}, {})} ${validate_component(Testimonials, "Testimonials").$$render($$result, {}, {}, {})}`;
});
export {
  Page as default
};
